...
st.sidebar.markdown("<p style='font-size: 11px; color: #7f8c8d; margin-top: 10px; padding-top: 5px; margin-bottom: 25px; font-weight: bold;'>ENVIRONMENTAL PUBLIC HEALTH OPERATIONS DEPARTMENT</p>", unsafe_allow_html=True)
